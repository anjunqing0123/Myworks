...
define("app/phone/up_down/up_down", [ "core/jquery/1.8.3/jquery", "../../../util/others/others", "../../../util/cookie/cookie", "core/underscore/1.8.3/underscore", "../../../util/swipe/swiper.min", "../../../util/vote/vote", "../../../util/loader/loader", "../../../util/log/log", "../../../util/platform/plt", "../../../util/browser/browser", "../../../util/net/urlquery", "../../../util/user/user", "client", "../../../util/Timer/timer", "../../../util/vote/uniformDate", "../../../util/ppsdk/sdkUtil", "../../../util/log/alertBox", "./../../../util/ppsdk/sdkUtil", "./../haixuan/haixuan", "../../../util/lazyload/loadmoreupdate" ], function(require) {
    ...
    var update = function(scoreA, scoreB) {
        // 周期获取数据更新票数
    ...
    if (inStage === "1") {
        others.cycleGetVotes(ids, function(data) {
            // 周期获取数据的方法
