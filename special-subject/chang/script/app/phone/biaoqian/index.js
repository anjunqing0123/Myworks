 ...
 */
define("app/phone/biaoqian/index", [ "core/jquery/1.8.3/jquery", "../../../util/swipe/swiper.min", "../../../util/Timer/timer", "../../../util/vote/uniformDate", "../../../util/others/getquery", "../../../util/ppsdk/sdk", "../../../util/browser/browser", "../haixuan/haixuan", "../../../util/loader/loader", "../../../util/log/log", "../../../util/platform/plt", "../../../util/net/urlquery", "../../../util/lazyload/loadmoreupdate", "./pklist", "../../../util/vote/vote", "../../../util/cookie/cookie", "../../../util/user/user", "client", "../../../util/vote/voteupdate", "./concert", "./tag60", "../../../util/others/others", "core/underscore/1.8.3/underscore", "../../../util/ppsdk/sdkUtil", "../../../util/log/alertBox", "./../../../util/ppsdk/sdkUtil" ], function(require, exports, module) {
...
define("app/phone/biaoqian/concert", [ "core/jquery/1.8.3/jquery", "util/loader/loader", "util/log/log", "util/platform/plt", "util/browser/browser", "util/net/urlquery", "util/others/getquery", "util/swipe/swiper.min", "util/Timer/timer", "util/vote/uniformDate" ], function(require, exports, module) {
    var $ = require("core/jquery/1.8.3/jquery");
    var ajaxLoad = require("util/loader/loader");
    var getQuery = require("util/others/getquery");
    var Swiper = require("util/swipe/swiper.min");
...
define("app/phone/biaoqian/tag60", [ "core/jquery/1.8.3/jquery", "util/swipe/swiper.min", "util/loader/loader", "util/log/log", "util/platform/plt", "util/browser/browser", "util/net/urlquery", "util/others/others", "util/cookie/cookie", "core/underscore/1.8.3/underscore", "util/vote/vote", "util/user/user", "client", "util/Timer/timer", "util/vote/uniformDate", "util/ppsdk/sdkUtil", "util/log/alertBox" ], function(require, exports, module) {
    ...
    //  living tag tpl
    var liveTpl = [ '<div class="module-tbtitle">', '   <div class="tbtitle_a">LIVE</div>', '   <div class="tbtitle_b">点击头像进入直播</div>', "</div>" ].join("");
    ...
    var update = function() {
        ...
        loader.ajax({
            ...
            success: function(data) {
                ...
                if (now < start) {
                    var nextUpdateTime = start - now + 30 * 1e3;
