 ...
 */
define("app/phone/haixuan/videoVote", [ "core/jquery/1.8.3/jquery", "./../../../util/loader/loader", "../../../util/log/log", "../../../util/platform/plt", "../../../util/browser/browser", "../../../util/net/urlquery" ], function(require, exports, module) {
    ...
    var token = function(obj, type, id) {
        loader.load("http://api.chang.pptv.com/vote/csrf", {}, function(data) {
    ...
    var increase = function(obj, type, id, token) {
        loader.load("http://api.chang.pptv.com/vote/" + id + "/increase", {
            token: token
        }, function(data) {
            console.info(data);
            if (data.errors) {
