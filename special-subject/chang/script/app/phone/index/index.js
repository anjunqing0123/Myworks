...
define("app/phone/index/index", [ "core/jquery/1.8.3/jquery", "./banner_slider", "../../../util/swipe/swiper.min", "./progress", "core/zepto/zepto", "./entrance", "../../../util/cookie/cookie", "../../../util/others/others", "core/underscore/1.8.3/underscore", "../../../util/vote/vote", "../../../util/loader/loader", "../../../util/log/log", "../../../util/platform/plt", "../../../util/browser/browser", "../../../util/net/urlquery", "../../../util/user/user", "client", "../../../util/Timer/timer", "../../../util/vote/uniformDate", "../../../util/ppsdk/sdkUtil", "../../../util/log/alertBox", "../../../util/ppsdk/share", "./xijin", "../../../util/vote/formatVote", "./pklist", "../../../util/vote/voteupdate", "./gold_601", "./gold_18", "./gold_10", "./gold_5", "./gold_3", "../../module/search/search" ], function(require) {
...
define("app/phone/index/gold_18", [ "util/loader/loader", "core/jquery/1.8.3/jquery", "util/log/log", "util/platform/plt", "util/browser/browser", "util/net/urlquery", "util/others/others", "util/cookie/cookie", "core/underscore/1.8.3/underscore", "util/swipe/swiper.min", "util/vote/vote", "util/user/user", "client", "util/Timer/timer", "util/vote/uniformDate", "util/ppsdk/sdkUtil", "util/log/alertBox" ], function(require) {
    var loader = require("util/loader/loader");
    var others = require("util/others/others");
    var vote = new (require("util/vote/vote"))();
    var _ = require("core/underscore/1.8.3/underscore");
...
define("app/phone/index/gold_10", [ "util/loader/loader", "core/jquery/1.8.3/jquery", "util/log/log", "util/platform/plt", "util/browser/browser", "util/net/urlquery", "util/others/others", "util/cookie/cookie", "core/underscore/1.8.3/underscore", "util/swipe/swiper.min", "util/vote/vote", "util/user/user", "client", "util/Timer/timer", "util/vote/uniformDate", "util/ppsdk/sdkUtil", "util/log/alertBox" ], function(require) {
    var loader = require("util/loader/loader");
    var others = require("util/others/others");
    var vote = new (require("util/vote/vote"))();
    var Swiper = require("util/swipe/swiper.min");
    ...
    // }
    /* 链接点击事件绑定 */
    $module.on("click", ".cont_w", function() {
    ...
    $module.on("click", ".bdr, .i_avartar", function() {
        var that = this;
    ...
    /* 投票绑定 */
    $module.on("click", ".vlist-btn, .module-gold10 .btn", function() {
        var sid = $(this).attr("sid");
        others.limitedDisable($(this), 3600, sid, function() {
    ...
    var voteInit = function() {
        $(".vlist-btn, .module-gold10 .btn").each(function() {
            var sid = $(this).attr("sid");
            others.limitedDisable($(this), 3600, sid);
        });
    };
    ...
    var update = function() {
        ...
        loader.ajax({
            ...
            // url: 'http://static9.pplive.cn/chang/datas/gold_10.js',
            jsonpCallback: "update_1",
            success: function(data) {
                clearList();
                var now = new Date().getTime();
...
define("app/phone/index/gold_5", [ "util/loader/loader", "core/jquery/1.8.3/jquery", "util/log/log", "util/platform/plt", "util/browser/browser", "util/net/urlquery", "util/others/others", "util/cookie/cookie", "core/underscore/1.8.3/underscore", "util/swipe/swiper.min", "util/vote/vote", "util/user/user", "client", "util/Timer/timer", "util/vote/uniformDate", "util/ppsdk/sdkUtil", "util/log/alertBox" ], function(require) {
    var loader = require("util/loader/loader");
    var others = require("util/others/others");
    var vote = new (require("util/vote/vote"))();
    var Swiper = require("util/swipe/swiper.min");
...
define("app/phone/index/gold_3", [ "util/loader/loader", "core/jquery/1.8.3/jquery", "util/log/log", "util/platform/plt", "util/browser/browser", "util/net/urlquery", "util/others/others", "util/cookie/cookie", "core/underscore/1.8.3/underscore", "util/swipe/swiper.min", "util/vote/vote", "util/user/user", "client", "util/Timer/timer", "util/vote/uniformDate", "util/ppsdk/sdkUtil", "util/log/alertBox" ], function(require) {
    var loader = require("util/loader/loader");
    var others = require("util/others/others");
    var _ = require("core/underscore/1.8.3/underscore");
    var $ = require("core/jquery/1.8.3/jquery");
