...
define("app/pc/playpage/120x60/index", [ "core/jquery/1.8.3/jquery", "core/underscore/1.8.3/underscore", "../../../../util/date/format", "../../../../util/Timer/timer", "../../../../util/vote/uniformDate", "../../../../util/vote/formatVote", "../../../../util/log/log", "../../../../util/loader/loader", "../../../../util/platform/plt", "../../../../util/browser/browser", "../../../../util/net/urlquery", "../../../../util/linkcfg/interfaceurl", "../../../../util/barrage/barrage", "client", "../../../../util/cookie/cookie", "../../../../util/user/user", "../../../../util/login/login", "../../../../util/user/user-fix", "../../../../util/event/event-aggregator", "../../../../util/barrage/emojione", "../../../../util/pub/main", "../../../../util/lazyload/delayload", "../../../../util/lazyload/webp", "../../personspace/limit", "../../../../util/barrage/player-plugin-barrage", "../../index/common-joinvip", "../../../../util/vote/voteupdate", "../../../../util/vote/vote" ], function(require, exports) {
    ...
    var template_live = '<div class="grid cf"><div class="pk-player-wrap rel cf">' + '<div class="vs-tag alCenter">' + "<h3>倒计时</h3>" + "<p></p>" + "<h2>VS</h2>" + "</div>" + '<div class="pk-player fl rel">' + '<a class="avatar-item" title="<%= player1_info.title %>" href="<%= player1_info.url %>" <%if(isClient==false){%>target="_blank"<%}%>>' + '  <img src="<%= player1_info.avatar %>" alt="<%= player1_info.title %>">' + ' <span class="alCenter title"><%= player1_info.real_name %></span>' + " </a>" + ' <a class="vote-icon js-vote" data-id="<%= player1_info.voteid %>" data-prior="1">' + " </a>" + '<i class="vote-add hidden"></i>' + '<i class="vote-mask hidden"></i>' + "<p><em><%= player1_info.votenum %></em>个顶</p>" + "<%if(player1_info.replace==true){%>" + '<i class="replace"></i>' + "<%} else { %>" + '<i class="num"><%=player1_info.rank%></i>' + " <% } %>" + "</div>" + '<div class="pk-player fr rel">' + '<a class="avatar-item" title="<%= player2_info.title %>" href="<%= player2_info.url %>" <%if(isClient==false){%>target="_blank"<%}%>>' + '   <img src="<%= player2_info.avatar %>" alt="<%= player2_info.title %>">' + '  <span class="alCenter title" title="<%= player2_info.title %>"><%= player2_info.real_name %></span>' + "</a>" + ' <a class="vote-icon js-vote" data-id="<%= player2_info.voteid %>" data-prior="1">' + " </a>" + '<i class="vote-add hidden"></i>' + '<i class="vote-mask hidden"></i>' + "  <p><em><%= player2_info.votenum %></em>个顶</p>" + "<%if(player2_info.replace==true){%>" + '<i class="replace"></i>' + "<%} else { %>" + '<i class="num"><%=player2_info.rank%></i>' + " <% } %>" + " </div>" + "</div></div>";
    //未开始
    ...
    function updateLive(obj, isend) {
        ...
        if (isend == false) {
            ...
            var tempEnd = new Date(obj.end * 1e3 + parseInt(Math.random() * 3e3));
    ...
    function updateAfter(arr) {
        ...
        if (arr.length == 0) {
            ...
            for (var i = arr.length - 1; i >= 0; i--) {
                //正序输出
                var tempDate = new Date(arr[i].end * 1e3);
        ...
        loader.load(urls["interface"]["PKList_pc"], tempData, function(data) {
            if (data.code == 1) {
                ...
                if (nowObj.length == 0 && afterArr.length == 0) {
                    ...
                    //防止cdn穿透
                    var endTime = new Date(nextTimer.start * 1e3 + parseInt(Math.random() * 3e3));
                    //需要异常处理
