...
define("app/pc/index/vod", [ "../../../util/pub/main", "core/underscore/1.8.3/underscore", "core/jquery/1.8.3/jquery", "../../../util/cookie/cookie", "../../../util/lazyload/delayload", "../../../util/lazyload/webp", "../../../util/login/login", "../../../util/user/user", "client", "../../../util/log/log", "./program-list", "../../../util/loader/loader", "../../../util/platform/plt", "../../../util/browser/browser", "../../../util/net/urlquery", "../../../util/date/format", "../../../util/event/event-aggregator", "../../../util/scroller/scroller", "../../../util/event/event-mouse-wheel", "../../../util/scroller/scroller.css", "./video", "./video-controller", "./group", "./group-controller", "../../../util/function/delay", "./living-controller", "./module", "./common-joinvip" ], function(require, exports, modules) {
    ...
    //输出节目列表开始
    var ProgrameList = require("./program-list");
    var programlist = new ProgrameList();
    //输出节目列表结束
    //加入vip模块
    require("./common-joinvip");
});
