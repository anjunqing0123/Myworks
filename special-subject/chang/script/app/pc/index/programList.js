...
define("app/pc/index/programList", [ "core/jquery/1.8.3/jquery", "./group", "core/underscore/1.8.3/underscore", "./group-controller", "../../../util/function/delay", "../../../util/event/event-aggregator", "../../../util/scroller/scroller", "../../../util/event/event-mouse-wheel", "../../../util/scroller/scroller.css", "../../../util/loader/loader", "../../../util/log/log", "../../../util/platform/plt", "../../../util/browser/browser", "../../../util/net/urlquery" ], function(require, exports) {
    ...
    function renderCollections(renderCollection, page, first) {
        ...
        var template_video = '<li  id="video-<%= id %>" data-index="<%= count %>">' + '<a href="javascript:;" title="<%= title %>" class="ui-list-ct" data-id="<%= id %>">' + '<dl class="cf">' + "<dt>" + '<img src="<%= picurl %>">' + "<i></i>" + "</dt>" + "<dd>" + '<p class="main-tt"><%= title %></p>' + "</dd>" + "<dd>" + '<p class="singer"><%= real_name %></p>' + "</dd>" + "</dl>" + "</a>" + "</li>";
        if (!$wrap_preload) {
