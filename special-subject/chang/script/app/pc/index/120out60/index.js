...
define("app/pc/index/120out60/index", [ "core/jquery/1.8.3/jquery", "../../../../util/flexSlider/flexSlider", "../../../../util/lazyload/delayload", "../../../../util/lazyload/webp", "../../../../util/photoslide/photoslide", "../flipclock", "../../../../util/sidemao/sidemao", "../../../../util/loader/loader", "../../../../util/log/log", "../../../../util/platform/plt", "../../../../util/browser/browser", "../../../../util/net/urlquery", "../../../../util/linkcfg/interfaceurl", "../../../../util/vote/uniformDate", "../../../../util/date/format", "../../../../util/vote/formatVote", "../../personspace/limit", "../../../../util/Timer/timer" ], function(require, exports) {
    ...
    function updatePKLive(obj, scopeid, needTimer, index) {
        ...
        playerDom1.attr({
            spaceurl: playerDom1.attr("href"),
            originTitle: playerDom1.attr("title")
        });
        playerDom2.attr({
            spaceurl: playerDom2.attr("href"),
            originTitle: playerDom2.attr("title")
        });
            ...
            timer({
                ...
                callback: function(status, times) {
                    if (status == 2) {
                        ...
                        playerDom1.attr({
                            href: playerDom1.attr("spaceurl"),
                            title: playerDom1.attr("originTitle")
                        });
                        playerDom2.attr({
                            href: playerDom2.attr("spaceurl"),
                            title: playerDom2.attr("originTitle")
                        });
                        if (needRemove == true) {
    ...
    function dispatchItem(obj, scopeid, needTimer, index) {
        ...
        //voteend 是时间戳
        var voteEndTime = obj.voteEndTime = obj.player_1.vote_end ? uniformDate(obj.player_1.vote_end * 1e3) : getEndVoteTime(endTime);
