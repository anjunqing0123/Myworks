...
define("app/pc/index/index", [ "../../../util/lazyload/delayload", "core/jquery/1.8.3/jquery", "../../../util/lazyload/webp", "./flipclock", "../../../util/cookie/cookie", "./vod", "../../../util/pub/main", "core/underscore/1.8.3/underscore", "../../../util/login/login", "../../../util/user/user", "client", "../../../util/log/log", "./program-list", "../../../util/loader/loader", "../../../util/platform/plt", "../../../util/browser/browser", "../../../util/net/urlquery", "../../../util/date/format", "../../../util/event/event-aggregator", "../../../util/scroller/scroller", "../../../util/event/event-mouse-wheel", "../../../util/scroller/scroller.css", "./video", "./video-controller", "./group", "./group-controller", "../../../util/function/delay", "./living-controller", "./module", "./common-joinvip", "../../../util/photoslide/photoslide", "../../../util/drag/drag", "../../../util/linkcfg/pcredirect", "../../../util/linkcfg/interfaceurl" ], function(require, module, exports) {
    // 图片后加载
    ...
    (function() {
        ...
        function showPop() {
            var $pop = $("" + '<div class="chang-pop" style="width:100%; height:100%; position:fixed; top:0; left:0; z-index:100">' + '<div class="popbox" style="width:420px; height:250px; position:absolute; background:url(http://sr2.pplive.com/cms/24/59/ce23433c069095be392ad1548939addb.png); cursor:default; -webkit-user-select:none;">' + '<h1 style="margin:16px 0 0 10px; font-size:18px; color:#000000;">温馨提示</h1>' + '<p style="color:#000000; width:320px; margin:46px auto 0 auto; font-size:16px; line-height:30px; letter-spacing:2px;">检测到您不是最新客户端，低版本不支持直播互动，请升级版本</p>' + '<a href="javascript:;" class="sbtn" style="font-size:12px; color:#ffffff; text-decoration:none; width:120px; height:30px; line-height:30px; text-align:center; display:block; background:#01afea; margin:40px auto 0 auto; letter-spacing:2px;">更新</a>' + '<a href="javascript:;" class="cbtn" style="background:url(http://sr1.pplive.com/cms/39/27/7e99a827d0255917874fb4df2fa4b4fe.png); width:13px; height:14px; display:block; position:absolute; top:17px; right:10px;"></a>' + "</div>" + "</div>");
            $cbtn = $pop.find(".cbtn");
            $sbtn = $pop.find(".sbtn");
            $box = $pop.find(".popbox");
...
*/
define("util/drag/drag", [], function() {
    /*--------------------------------------------------------------
Draggable
    ...
    return function($) {
        $.fn.draggable = function() {
            this.on("mousedown touchstart", function(e) {
                var $dragged = $(this);
                var x = $dragged.offset().left - e.pageX, y = $dragged.offset().top - e.pageY, z = $dragged.css("z-index");
