...
*/
define("app/pc/client/18x9", [ "core/jquery/1.8.3/jquery", "../../../util/cookie/cookie", "../../../util/loader/loader", "../../../util/log/log", "../../../util/platform/plt", "../../../util/browser/browser", "../../../util/net/urlquery", "../../../util/linkcfg/interfaceurl", "../../../util/numbertochinese/numbertochinese", "../../../util/vote/formatVote", "core/underscore/1.8.3/underscore", "../../../util/vote/vote", "../../../util/user/user", "client", "../../../util/countdown/countdown", "../../../util/eventpause/eventpause" ], function(require, exports) {
    var $ = require("core/jquery/1.8.3/jquery"), cookie = require("../../../util/cookie/cookie"), Loader = require("../../../util/loader/loader"), api = require("../../../util/linkcfg/interfaceurl")["interface"], numToChinese = require("../../../util/numbertochinese/numbertochinese"), formatVote = require("../../../util/vote/formatVote"), _ = require("core/underscore/1.8.3/underscore"), ChangVote = require("../../../util/vote/vote");
    ...
    (function() {
        var tp = _.template("" + '<dd class="cf">' + '<a href="javascript:;" title="<%= name %>" class="name fl"><%= name %></a>' + '<div class="fr">' + "<p>登乐时间：<%= times %>s</p>" + "<p>" + '<span class="zan">前进：<%= praise %>票</span>' + '<span class="cai">后退：<%= hate %>票</span>' + "</p>" + "</div>" + "<%= up ? '<i class=\"jinji\"></i>':'' %>" + "</dd>");
...
/* 
* @Author: WhiteWang
* @Date:   2015-10-29 10:38:28
* @Last Modified by:   weifengwang
* @Last Modified time: 2015-10-29 12:08:28
*/
//http://www.cnblogs.com/breakdown/archive/2012/09/20/2689306.html
define("util/numbertochinese/numbertochinese", [], function(require, exports) {
    var change = {
