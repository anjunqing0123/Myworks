...
define("app/pc/canvaslib/loadingEffect/Base", [ "../tool/util", "../dep/excanvas", "../shape/Text", "../tool/area", "../tool/curve", "../tool/vector", "../shape/Base", "../tool/matrix", "../tool/guid", "../tool/log", "../config", "../mixin/Transformable", "../mixin/Eventful", "../tool/color", "../shape/Rectangle" ], function(require, exports, module) {
    /**
 * zrender: loading特效类
 *
