...
define("app/pc/canvaslib/zrender", [ "./dep/excanvas", "./tool/util", "./tool/log", "./config", "./tool/guid", "./Handler", "./tool/env", "./tool/event", "./mixin/Eventful", "./tool/vector", "./tool/matrix", "./Painter", "./loadingEffect/Base", "./shape/Text", "./tool/area", "./tool/curve", "./shape/Base", "./mixin/Transformable", "./tool/color", "./shape/Rectangle", "./shape/Image", "./Storage", "./Group", "./animation/Animation", "./animation/Clip", "./animation/easing" ], function(require, exports, module) {
    /*!
