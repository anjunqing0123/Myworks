...
define("app/pc/canvaslib/shape/Path", [ "./Base", "../tool/matrix", "../tool/guid", "../tool/util", "../dep/excanvas", "../tool/log", "../config", "../mixin/Transformable", "../tool/vector", "../mixin/Eventful", "../tool/area", "../tool/curve", "../tool/color", "./util/PathProxy" ], function(require, exports, module) {
    /**
 * SVG Path
