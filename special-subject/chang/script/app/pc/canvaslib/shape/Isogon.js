...
define("app/pc/canvaslib/shape/Isogon", [ "../tool/math", "./Base", "../tool/matrix", "../tool/guid", "../tool/util", "../dep/excanvas", "../tool/log", "../config", "../mixin/Transformable", "../tool/vector", "../mixin/Eventful", "../tool/area", "../tool/curve", "../tool/color" ], function(require, exports, module) {
    /**
 * 正多边形
