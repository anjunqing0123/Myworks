...
define("app/pc/canvaslib/shape/BezierCurve", [ "./Base", "../tool/matrix", "../tool/guid", "../tool/util", "../dep/excanvas", "../tool/log", "../config", "../mixin/Transformable", "../tool/vector", "../mixin/Eventful", "../tool/area", "../tool/curve", "../tool/color" ], function(require, exports, module) {
    /**
 * 贝塞尔曲线
