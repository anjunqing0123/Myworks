...
define("app/pc/canvaslib/shape/Trochoid", [ "./Base", "../tool/matrix", "../tool/guid", "../tool/util", "../dep/excanvas", "../tool/log", "../config", "../mixin/Transformable", "../tool/vector", "../mixin/Eventful", "../tool/area", "../tool/curve", "../tool/color", "../tool/math" ], function(require, exports, module) {
    /**
 * 内外旋轮曲线
