...
define("app/pc/canvaslib/Painter", [ "./config", "./tool/util", "./dep/excanvas", "./tool/log", "./tool/matrix", "./loadingEffect/Base", "./shape/Text", "./tool/area", "./tool/curve", "./tool/vector", "./shape/Base", "./tool/guid", "./mixin/Transformable", "./mixin/Eventful", "./tool/color", "./shape/Rectangle", "./shape/Image" ], function(require, exports, module) {
    /**
 * Painter绘图模块
