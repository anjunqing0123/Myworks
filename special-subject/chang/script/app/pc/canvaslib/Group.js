...
define("app/pc/canvaslib/Group", [ "./tool/guid", "./tool/util", "./dep/excanvas", "./mixin/Transformable", "./tool/matrix", "./tool/vector", "./mixin/Eventful" ], function(require, exports, module) {
    /**
