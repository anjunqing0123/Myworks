...
define("app/pad/index/index", [ "core/jquery/1.8.3/jquery", "../../phone/index/banner_slider", "../../../util/swipe/swiper.min", "../../phone/index/progress", "core/zepto/zepto", "../../phone/index/entrance", "../../../util/cookie/cookie", "../../../util/others/others", "core/underscore/1.8.3/underscore", "../../../util/vote/vote", "../../../util/loader/loader", "../../../util/log/log", "../../../util/platform/plt", "../../../util/browser/browser", "../../../util/net/urlquery", "../../../util/user/user", "client", "../../../util/Timer/timer", "../../../util/vote/uniformDate", "../../../util/ppsdk/sdkUtil", "../../../util/log/alertBox", "../../../util/ppsdk/share", "./xijin", "../../../util/ppsdk/sdk", "./pklist", "../../../util/vote/voteupdate", "./gold_60", "./gold_18", "./gold_10", "./gold_5", "./gold_3", "../../module/search/search" ], function(require) {
    var $ = require("core/jquery/1.8.3/jquery");
    require("../../phone/index/banner_slider");
    require("../../phone/index/progress");
    require("../../phone/index/entrance");
    ...
    require("../../module/search/search");
});

define("app/phone/index/banner_slider", [ "core/jquery/1.8.3/jquery", "util/swipe/swiper.min" ], function(require) {
    var $ = require("core/jquery/1.8.3/jquery");
    var Swiper = require("util/swipe/swiper.min");
    var $selector = $(".module-banner-slider .swiper-container");
    $selector.each(function() {
        var $pagination = $(this).find(".swiper-pagination");
        var autoplay = 3e3, loop = true;
...
define("app/phone/index/progress", [ "core/zepto/zepto", "util/swipe/swiper.min" ], function(require) {
...
define("app/phone/index/entrance", [ "core/zepto/zepto", "util/cookie/cookie", "util/others/others", "core/jquery/1.8.3/jquery", "core/underscore/1.8.3/underscore", "util/swipe/swiper.min", "util/vote/vote", "util/loader/loader", "util/log/log", "util/platform/plt", "util/browser/browser", "util/net/urlquery", "util/user/user", "client", "util/Timer/timer", "util/vote/uniformDate", "util/ppsdk/sdkUtil", "util/log/alertBox", "util/ppsdk/sdkUtil", "util/ppsdk/share" ], function(require, module, exports) {
    var $ = require("core/zepto/zepto");
...
define("util/others/others", [ "core/jquery/1.8.3/jquery", "util/cookie/cookie", "core/underscore/1.8.3/underscore", "util/swipe/swiper.min", "util/vote/vote", "util/loader/loader", "util/log/log", "util/platform/plt", "util/browser/browser", "util/net/urlquery", "util/user/user", "client", "util/Timer/timer", "util/vote/uniformDate", "util/ppsdk/sdkUtil", "util/log/alertBox" ], function(require, module, exports) {
    var $ = require("core/jquery/1.8.3/jquery");
    var cookie = require("util/cookie/cookie");
    var _ = require("core/underscore/1.8.3/underscore");
    var Swiper = require("util/swipe/swiper.min");
    var vote = new (require("util/vote/vote"))();
...
define("util/ppsdk/share", [ "util/ppsdk/sdkUtil", "core/jquery/1.8.3/jquery", "util/log/alertBox" ], function(require, exports, module) {
    var sdk = require("util/ppsdk/sdkUtil");
    //分享按钮
...
define("app/pad/index/xijin", [ "core/jquery/1.8.3/jquery", "util/loader/loader", "util/log/log", "util/platform/plt", "util/browser/browser", "util/net/urlquery", "util/ppsdk/sdk", "util/swipe/swiper.min", "util/Timer/timer", "util/vote/uniformDate" ], function(require, exports) {
    var $ = require("core/jquery/1.8.3/jquery");
    var loader = require("util/loader/loader");
...
define("app/pad/index/gold_60", [ "util/loader/loader", "core/jquery/1.8.3/jquery", "util/log/log", "util/platform/plt", "util/browser/browser", "util/net/urlquery", "util/others/others", "util/cookie/cookie", "core/underscore/1.8.3/underscore", "util/swipe/swiper.min", "util/vote/vote", "util/user/user", "client", "util/Timer/timer", "util/vote/uniformDate", "util/ppsdk/sdkUtil", "util/log/alertBox" ], function(require) {
    var loader = require("util/loader/loader");
    ...
    var $moduleTab = $(".module-myconcert");
    $moduleTab.find(".swiper-slide").click(function() {
        $(this).parents(".module-myconcert").find(".swiper-slide").removeClass("active");
    ...
    $module.on("click", ".picw, .avartar", function() {
    ...
    var swiperProgress = function(i) {
        $moduleTab.find(".swiper-slide").eq(dayIndex).addClass("active");
        progressSlider.detachEvents && progressSlider.detachEvents();
        progressSlider = new Swiper(".swiper-container", {
            slidesPerView: "auto",
            initialSlide: i - 1
        });
    };
    var dayIndex = $(".module-myconcert").find(".swiper-slide.active").index();
        ...
        loader.ajax({
            ...
            success: function(data) {
                ...
                var $html = $(compiled({
                    ...
                    isIndayClass: function(start, i) {
                        // 如果是今天就返回一个indayclass，添加到gold_60就显示。
                        if (dayIndex === i) {
                            return " inday";
                        } else {
                            return "";
...
define("app/pad/index/gold_18", [ "util/loader/loader", "core/jquery/1.8.3/jquery", "util/log/log", "util/platform/plt", "util/browser/browser", "util/net/urlquery", "util/others/others", "util/cookie/cookie", "core/underscore/1.8.3/underscore", "util/swipe/swiper.min", "util/vote/vote", "util/user/user", "client", "util/Timer/timer", "util/vote/uniformDate", "util/ppsdk/sdkUtil", "util/log/alertBox" ], function(require) {
    var loader = require("util/loader/loader");
    var others = require("util/others/others");
    var vote = new (require("util/vote/vote"))();
    var Swiper = require("util/swipe/swiper.min");
    ...
    var nextUpdate = 0, stage = "before", goback = false;
    var updateBefore = function() {
        // 直播前的数据更新
        var isVoteEnd = false, liveStart = false;
        loader.ajax({
            ...
            success: function(data) {
                ...
                if (data.data.area) {
                    ...
                    nextUpdate = Number(area[0].vote.endedAt) * 1e3 - now;
                    // 直播前投票结束时间点
                    if (nextUpdate < 0) {
                        isVoteEnd = true;
                    }
                ...
                if (data.data.liveinfo) {
                    ...
                    if (nextUpdate < 0) {
                        nextUpdate = others.newDate(liveinfo.start).getTime() - now;
                        // 直播开始时间点
                        if (nextUpdate < 0) {
                            liveStart = true;
                        }
                    ...
                    if (nextUpdate < 0) {
                        nextUpdate = others.newDate(liveinfo.end).getTime() - now;
                    }
                }
                var sortScopeList = [];
...
define("app/pad/index/gold_10", [ "util/loader/loader", "core/jquery/1.8.3/jquery", "util/log/log", "util/platform/plt", "util/browser/browser", "util/net/urlquery", "util/others/others", "util/cookie/cookie", "core/underscore/1.8.3/underscore", "util/swipe/swiper.min", "util/vote/vote", "util/user/user", "client", "util/Timer/timer", "util/vote/uniformDate", "util/ppsdk/sdkUtil", "util/log/alertBox" ], function(require) {
    var loader = require("util/loader/loader");
    var others = require("util/others/others");
    var vote = new (require("util/vote/vote"))();
    var Swiper = require("util/swipe/swiper.min");
    ...
    var nextUpdate = 0, stage = 0, goback = false;
    var update = function() {
        // 直播前的数据更新
        var isVoteEnd = false, liveStart = false;
        loader.ajax({
            ...
            success: function(data) {
                ...
                nextUpdate = Number(sortedPlayers[0].vote_end) * 1e3 - now;
                // 直播前投票结束时间点
                if (nextUpdate < 0) {
                    stage = 1;
                    nextUpdate = others.newDate(liveInfo.start).getTime() - now;
                ...
                if (nextUpdate < 0 && getIsRank(sortedPlayers, idolInfo)) {
                    ...
                    if (nextUpdate !== "finish") {
                        nextUpdate = Math.min(60 * 1e3 * 30, nextUpdate);
                        setTimeout(update, nextUpdate);
                    }
                }
            }
...
define("app/pad/index/gold_5", [ "util/loader/loader", "core/jquery/1.8.3/jquery", "util/log/log", "util/platform/plt", "util/browser/browser", "util/net/urlquery", "util/others/others", "util/cookie/cookie", "core/underscore/1.8.3/underscore", "util/swipe/swiper.min", "util/vote/vote", "util/user/user", "client", "util/Timer/timer", "util/vote/uniformDate", "util/ppsdk/sdkUtil", "util/log/alertBox" ], function(require) {
    var loader = require("util/loader/loader");
    var others = require("util/others/others");
    var vote = new (require("util/vote/vote"))();
    var Swiper = require("util/swipe/swiper.min");
    ...
    $module.on("click", ".bdr, .i_avartar, .picw", function() {
        var that = this;
        var link = $(this).parents(".module-vtlist.module-gold10").attr("link");
        var appLink = $(this).parents(".module-vtlist.module-gold10").attr("applink");
        if (link && appLink) {
            if (others.checkIsInApp()) {
                location.href = link;
            } else {
    ...
    var update = function() {
        ...
        loader.ajax({
            ...
            success: function(data) {
                ...
                if (nextUpdate !== "finish") {
                    nextUpdate = Math.min(60 * 1e3 * 30, nextUpdate);
                    console.log(nextUpdate / 1e3 / 60, "分钟后更新");
                    setTimeout(update, nextUpdate);
                }
            }
        });
...
define("app/pad/index/gold_3", [ "util/loader/loader", "core/jquery/1.8.3/jquery", "util/log/log", "util/platform/plt", "util/browser/browser", "util/net/urlquery", "util/others/others", "util/cookie/cookie", "core/underscore/1.8.3/underscore", "util/swipe/swiper.min", "util/vote/vote", "util/user/user", "client", "util/Timer/timer", "util/vote/uniformDate", "util/ppsdk/sdkUtil", "util/log/alertBox" ], function(require) {
    var loader = require("util/loader/loader");
    var others = require("util/others/others");
    var _ = require("core/underscore/1.8.3/underscore");
    var $ = require("core/jquery/1.8.3/jquery");
