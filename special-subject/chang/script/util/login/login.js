 ...
 * @info    通用login
 */
define("util/login/login", [ "core/jquery/1.8.3/jquery", "../user/user", "client", "../cookie/cookie" ], function(require) {
    var $ = require("core/jquery/1.8.3/jquery"), user = require("../user/user"), cookie = require("../cookie/cookie"), doc = document, ipadPlayer = function(s) {
