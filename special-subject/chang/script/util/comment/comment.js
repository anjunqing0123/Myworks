 ...
 * @info    评论模块整理
 */
define("util/comment/comment", [ "core/jquery/1.8.3/jquery", "../cookie/cookie", "../user/user", "client", "../login/login" ], function(require, exports, modules) {
    var $ = require("core/jquery/1.8.3/jquery"), cookie = require("../cookie/cookie"), user = require("../user/user"), login = require("../login/login");
    if ($.Comment) {
        return;
    }
