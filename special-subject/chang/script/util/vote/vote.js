...
*/
define("util/vote/vote", [ "core/jquery/1.8.3/jquery", "../cookie/cookie", "../loader/loader", "../log/log", "../platform/plt", "../browser/browser", "../net/urlquery", "../user/user", "client" ], function(require, exports, module) {
    /**
 * [一唱成名投票模块]
