 ...
 */
define("util/ppsdk/sdkUtil", [ "core/jquery/1.8.3/jquery", "./../log/alertBox" ], function(require, exports, module) {
    var $ = require("core/jquery/1.8.3/jquery"), alertBox = require("./../log/alertBox");
    ppsdk.config({
        api: [],
        //本页面用到的js接口列表(暂时不支持)
        signature: "",
