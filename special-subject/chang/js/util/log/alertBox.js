...
define(function(require, exports, module){
		var w = window,d = document, $ = require('jquery');
		'use strict';
        ...
        AlertBox.prototype = {
            ...
            setStyle: function(){
               ...
               cssStr = ".alert-box{position:absolute;left:0;top:0;border-radius:0.2rem;background:#FFF;-webkit-box-sizing:border-box;z-index:200;font-size:0.6rem;}" +
                        ".alert-msg{padding:0.4rem 0.6rem 0.6rem;text-align:center;line-height:1.8;word-break:break-all;font-size:.4rem;}" +
